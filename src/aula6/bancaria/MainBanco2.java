...
public class MainBanco2 {
    ...
    public static ContaBancaria getConta(ArrayList<ContaBancaria> lstContas) {
    ...
    public static boolean getConta(ArrayList<ContaBancaria> lstContas, ContaBancaria cbTmp) {
        String conta = JOptionPane.showInputDialog("Conta:");
